...
const validarDados = async function(filmeDiretor){
    ...
    }else if(filmeDiretor.id_diretor == undefined || filmeDiretor.id_diretor == null || filmeDiretor.id_diretor.length > 45 || isNaN(filmeDiretor.id_diretor) || filmeGenero.id_genero <= 0){
